...
def generate_launch_description():
    ...
    bridge_config_file_path = os.path.join(pkg_eta_gz, 'config', 'bridge_config.yaml')

    entity_arg = DeclareLaunchArgument(
        'entity', default_value='eta', description='Name of the entity to bridge with Gazebo.')
